...
@Component({
  selector: 'app-staff-attsummchart',
  templateUrl: './staffattsummchart.component.html',
  styleUrls: ['./staffattsummchart.component.css'],
  animations: [FadeAnimation],
  
})

export class StaffAttendanceSummaryChartComponent implements OnInit, OnChanges {  
  ...
  GetOne() {    
    if (this.staffid > 0) {
      this.isLoading = true;
      this.http.get(AppSettings.API_ENDPOINT + "api/staffattendance1/getbystaffid/" + this.staffid, {
